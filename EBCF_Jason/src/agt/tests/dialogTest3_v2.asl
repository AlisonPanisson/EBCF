...
+!respondQuestion(Sender,Content,D): argument(Content,Justification) & enthymemetisation(Justification,JE,AS,Unifier) & .my_name(MyName) & .print("Received Message:  QUESTION(",Sender, ",", MyName, ","  ,Content,")")
